...
from src.service.common.collectorService import get_soup_by_content, all_attributes_for_all_elements, tags_text, \
    tag_text
from src.service.common.htmlTemplateService import create_second_product_template
